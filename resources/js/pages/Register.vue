                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-danger" v-if="has_error && !success">
                            ...
                            <p v-else>Errors, can not register at the moment. If the problem persists, please contact an Administrator.</p>
                        </div>
                        <form autocomplete="off" @submit.prevent="register" v-if="!success" method="post">
                            ...
                            <div class="form-group row" v-bind:class="{ 'has-error': has_error && errors.password }">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="invalid-feedback" role="alert" v-if="has_error && errors.password">{{ errors.password }}</span>
                                </div>
                            </div>
                            <div class="form-group row" v-bind:class="{ 'has-error': has_error && errors.password }">
